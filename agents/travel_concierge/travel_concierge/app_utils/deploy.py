...
@click.option(
    "--description",
    default="Orchestrates personalized travel experiences, illustrates means to integrate booking systems, and provides support throughout the traveler's journey, from initial planning, booking, to real-time itinerary services and alerts.",
...
@click.option(
    "--entrypoint-module",
    default="travel_concierge.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="travel_concierge/app_utils/.requirements.txt",

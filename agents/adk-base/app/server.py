...
bucket_name = f"gs://{project_id}-adk-base-logs"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "adk-base")
...
app.title = "adk-base"
app.description = "API for interacting with the Agent adk-base"

...
bucket_name = f"gs://{project_id}-agentic-rag-logs"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "agentic-rag")
...
app.title = "agentic-rag"
app.description = "API for interacting with the Agent agentic-rag"

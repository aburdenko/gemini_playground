...
vector_search_index = os.getenv(
    "VECTOR_SEARCH_INDEX", "agentic-rag-vector-search"
)
vector_search_index_endpoint = os.getenv(
    "VECTOR_SEARCH_INDEX_ENDPOINT", "agentic-rag-vector-search-endpoint"
)
vector_search_bucket = os.getenv(
    "VECTOR_SEARCH_BUCKET", f"{project_id}-agentic-rag-vs"
)

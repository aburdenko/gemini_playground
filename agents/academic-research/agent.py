...
# This file makes the academic-research agent discoverable by the ADK web server.
...
if not RAG_CORPUS:
    raise ValueError("RAG_CORPUS environment variable not set. Please check your agents/academic-research/.env file.")
